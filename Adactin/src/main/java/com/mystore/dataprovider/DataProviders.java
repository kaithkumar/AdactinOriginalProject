...
//Class --> AddToCartPageTest, EndToEndTest,  Test Case--> addToCartTest, endToEndTest	
	...
	public Object[][] searchHotel() {
		...
		int rowCount = obj.getRowCount("Adactin");
		int columnCount = obj.getColumnCount("Adactin");
		rowCount= rowCount-1;
		dataTable= new Object[rowCount][1];
		for(int i=0; i<rowCount; i++)
		{
			Map<String,String>hm=new HashMap<String,String>();
			for(int j=0; j<columnCount; j++)
			{
				hm.put(obj.getCellData("Adactin", j, 1), obj.getCellData("Adactin", j, i+2));
